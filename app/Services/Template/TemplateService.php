    ...
    public function processQuotes($quotes): array
    {
        ...
        return collect($quotes)->map(function ($quote) {
            return [
                ...
                'custom_value5' => (string) $quote->custom_value5 ?: '',
                'custom_value6' => (string) $quote->custom_value6 ?: '',
                'custom_value7' => (string) $quote->custom_value7 ?: '',
                'custom_value8' => (string) $quote->custom_value8 ?: '',
        ...
        $credits = collect($credits)
                ->map(function ($credit) {
                    ...
                    return [
                        ...
                        'custom_value5' => (string) $credit->custom_value5 ?: '',
                        'custom_value6' => (string) $credit->custom_value6 ?: '',
                        'custom_value7' => (string) $credit->custom_value7 ?: '',
                        'custom_value8' => (string) $credit->custom_value8 ?: '',
    ...
    public function processPurchaseOrders($purchase_orders): array
    {
        ...
        return collect($purchase_orders)->map(function ($purchase_order) {
            ...
            return [
                ...
                'custom_value5' => (string)$purchase_order->custom_value5 ?: '',
                'custom_value6' => (string)$purchase_order->custom_value6 ?: '',
                'custom_value7' => (string)$purchase_order->custom_value7 ?: '',
                'custom_value8' => (string)$purchase_order->custom_value8 ?: '',
