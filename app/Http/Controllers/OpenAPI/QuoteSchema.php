 ...
 *       @OA\Property(property="custom_value5", type="string", example="A custom value", description="Custom value field"),
 *       @OA\Property(property="custom_value6", type="string", example="A custom value", description="Custom value field"),
 *       @OA\Property(property="custom_value7", type="string", example="A custom value", description="Custom value field"),
 *       @OA\Property(property="custom_value8", type="string", example="A custom value", description="Custom value field"),
