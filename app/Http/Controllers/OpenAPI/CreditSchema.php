 ...
 *       @OA\Property(property="custom_value5", type="string", example="", description="A Custom value"),
 *       @OA\Property(property="custom_value6", type="string", example="", description="A Custom value"),
 *       @OA\Property(property="custom_value7", type="string", example="", description="A Custom value"),
 *       @OA\Property(property="custom_value8", type="string", example="", description="A Custom value"),
