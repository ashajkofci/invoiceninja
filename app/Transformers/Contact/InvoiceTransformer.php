...
class InvoiceTransformer extends EntityTransformer
{
    ...
    public function transform(Invoice $invoice)
    {
        return [
            ...
            'custom_value5' => (bool) $invoice->custom_value5,
            'custom_value6' => (bool) $invoice->custom_value6,
            'custom_value7' => (bool) $invoice->custom_value7,
            'custom_value8' => (bool) $invoice->custom_value8,
