...
class BaseExport
{
    ...
    protected array $invoice_report_keys = [
        ...
        "custom_value5" => "invoice.custom_value5",
        "custom_value6" => "invoice.custom_value6",
        "custom_value7" => "invoice.custom_value7",
        "custom_value8" => "invoice.custom_value8",
    ...
    protected array $recurring_invoice_report_keys = [
        ...
        "custom_value5" => "recurring_invoice.custom_value5",
        "custom_value6" => "recurring_invoice.custom_value6",
        "custom_value7" => "recurring_invoice.custom_value7",
        "custom_value8" => "recurring_invoice.custom_value8",
    ...
    protected array $purchase_order_report_keys = [
        ...
        'custom_value5' => 'purchase_order.custom_value5',
        'custom_value6' => 'purchase_order.custom_value6',
        'custom_value7' => 'purchase_order.custom_value7',
        'custom_value8' => 'purchase_order.custom_value8',
    ...
    protected array $item_report_keys = [
        ...
        "custom_value5" => "item.custom_value5",
        "custom_value6" => "item.custom_value6",
        "custom_value7" => "item.custom_value7",
        "custom_value8" => "item.custom_value8",
    ...
    protected array $quote_report_keys = [
        ...
        'custom_value5' => 'quote.custom_value5',
        'custom_value6' => 'quote.custom_value6',
        'custom_value7' => 'quote.custom_value7',
        'custom_value8' => 'quote.custom_value8',
        "number" => "quote.number",
        "amount" => "quote.amount",
    ...
    protected array $credit_report_keys = [
        ...
        "custom_value5" => "credit.custom_value5",
        "custom_value6" => "credit.custom_value6",
        "custom_value7" => "credit.custom_value7",
        "custom_value8" => "credit.custom_value8",
