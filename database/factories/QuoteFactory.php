...
class QuoteFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            // 'custom_value5' => $this->faker->numberBetween(1, 4),
            // 'custom_value6' => $this->faker->numberBetween(1, 4),
            // 'custom_value7' => $this->faker->numberBetween(1, 4),
            // 'custom_value8' => $this->faker->numberBetween(1, 4),
            'is_deleted' => false,
